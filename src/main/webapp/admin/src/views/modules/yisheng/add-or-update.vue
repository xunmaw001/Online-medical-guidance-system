          ...
          <el-form-item class="input" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="密码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所属医院" prop="suoshuyiyuan">
          <el-select v-model="ruleForm.suoshuyiyuan" placeholder="请选择所属医院">
            <el-option
                v-for="(item,index) in suoshuyiyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                this.suoshuyiyuanOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.$http({
              url: `option/zhichengliebiao/zhicheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
